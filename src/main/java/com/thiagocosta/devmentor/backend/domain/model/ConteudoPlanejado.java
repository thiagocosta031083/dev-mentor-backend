...
public class ConteudoPlanejado {
    ...
    public ConteudoPlanejado(
            Tecnologia tecnologia, String titulo, TipoConteudo tipo, Integer peso) {
    ...
    public void atualizar(String titulo, TipoConteudo tipo, Integer peso) {
        this.titulo = titulo;
        this.tipo = tipo;
        this.peso = peso;
    }
    ...
    public void iniciar() {
        this.status = StatusConteudo.EM_ANDAMENTO;
    }

    public void concluir(NivelDominio nivelDominio) {
        this.status = StatusConteudo.CONCLUIDO;
