...
public class PlanejamentoEstudo {
    ...
    public PlanejamentoEstudo(
            Tecnologia tecnologia,
            LocalDate dataInicio,
            LocalDate dataFim,
            Double horasPlanejadasTotais,
            Double horasSemanais,
            String observacao) {
        this.tecnologia = tecnologia;
        this.dataInicio = dataInicio;
        this.dataFim = dataFim;
        this.horasPlanejadasTotais = horasPlanejadasTotais;
    ...
    public Double getHorasPlanejadasTotais() {
        return horasPlanejadasTotais;
    }
    ...
    public void atualizar(
            LocalDate inicio, LocalDate fim, Double totais, Double semanais, String observacao) {
        this.dataInicio = inicio;
        this.dataFim = fim;
        this.horasPlanejadasTotais = totais;
        this.horasSemanais = semanais;
        this.observacao = observacao;
    }
}
