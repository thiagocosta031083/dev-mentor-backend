...
public class Tecnologia {
    ...
    public Tecnologia(String nome, TipoTecnologia tipo, String descricao, Double cargaHorariaPlanejada, Usuario usuario) {
        this.nome = nome;
        this.tipo = tipo;
    ...
    public void atualizar(String nome, TipoTecnologia tipo, String descricao, Double cargaHorariaPlanejada) {
        this.nome = nome; this.tipo = tipo; this.descricao = descricao; this.cargaHorariaPlanejada = cargaHorariaPlanejada;
    }
    public void ativar() { this.status = StatusTecnologia.ATIVA; }
    public void inativar() { this.status = StatusTecnologia.INATIVA; }
}
