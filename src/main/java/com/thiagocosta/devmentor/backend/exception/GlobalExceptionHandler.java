...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> notFound(
            ResourceNotFoundException e, HttpServletRequest r) {
    ...
    public ResponseEntity<ErrorResponseDTO> credentials(
            BadCredentialsException e, HttpServletRequest r) {
        return build(
    ...
    public ResponseEntity<ErrorResponseDTO> malformed(
            HttpMessageNotReadableException e, HttpServletRequest r) {
        return build(
                HttpStatus.BAD_REQUEST,
                "INVALID_REQUEST",
                "JSON ausente, malformado ou com valor inválido",
                r,
                null);
    }

    @ExceptionHandler(DataIntegrityViolationException.class)
    public ResponseEntity<ErrorResponseDTO> integrity(
        ...
        return ResponseEntity.status(status)
                .body(
                        new ErrorResponseDTO(
                                status.value(), error, message, request.getRequestURI(), fields));
    }
}
