...
public class TecnologiaResponseDTO {
    ...
    private final TipoTecnologia tipo;
    private final String descricao;
    private final Double cargaHorariaPlanejada;
    private final StatusTecnologia status;
    ...
    public TecnologiaResponseDTO(Tecnologia t) {
        ...
        cargaHorariaPlanejada = t.getCargaHorariaPlanejada();
        status = t.getStatus();
    }
