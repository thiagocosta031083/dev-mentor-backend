...
public class DashboardResponseDTO {
    ...
    private final double horasPlanejadas;
    private final double horasRealizadas;
    private final long conteudosPlanejados;
    private final long conteudosConcluidos;
    private final double cobertura;
    private final double esforco;
    private final double pratica;
    private final double evolucao;
    ...
    public DashboardResponseDTO(
        ...
        horasPlanejadas = hp;
        horasRealizadas = hr;
        conteudosPlanejados = cp;
        conteudosConcluidos = cc;
    ...
    public long getConteudosPlanejados() {
        return conteudosPlanejados;
    }
    ...
    public double getPercentualEsperado() {
        return percentualEsperado;
    }

    public StatusEvolucao getStatus() {
        return status;
    }
}
