...
public class TecnologiaRequestDTO {
    ...
    @NotNull private TipoTecnologia tipo;

    @Size(max = 500)
    private String descricao;

    @NotNull @Positive private Double cargaHorariaPlanejada;
    ...
    public void setCargaHorariaPlanejada(Double valor) {
        this.cargaHorariaPlanejada = valor;
    }
}
