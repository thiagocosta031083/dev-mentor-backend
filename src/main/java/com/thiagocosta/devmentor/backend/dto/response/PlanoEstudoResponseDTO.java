...
public class PlanoEstudoResponseDTO {
    ...
    private final Double horasPlanejadasTotais;
    private final Double horasSemanais;
    private final String observacao;

    public PlanoEstudoResponseDTO(PlanejamentoEstudo p) {
        id = p.getId();
        tecnologiaId = p.getTecnologia().getId();
        dataInicio = p.getDataInicio();
        dataFim = p.getDataFim();
        horasPlanejadasTotais = p.getHorasPlanejadasTotais();
        horasSemanais = p.getHorasSemanais();
